...
On any platform, don't warry about C include path, Nore could generate it for you.

I prefer non plugin Vim settings, so I can easily work on my all machines. [[https://raw.githubusercontent.com/junjiemars/kit/master/ul/.vimrc][download non-plugin .vimrc]].
