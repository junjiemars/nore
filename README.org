...
- Keep things simple: classic workflow (configure, make and make
  install).
- Write, Build, Test and Run code on anywhere: Linux, Darwin, Windows
  or Docker.
...
Suppose project /P/ has /A/ and /B/ two targets, one is a
/Executable/, the other is a /Library/
...
Suppose there are /A/, /B/ and /C/ projects, those projects use one
Nore clone.
