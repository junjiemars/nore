...
On any platform, don't warry about C include path, Nore should generate it for you.

I prefer non plugin Vim settings, so I can easily working on my all machines. [[https://raw.githubusercontent.com/junjiemars/kit/master/ul/.vimrc][download non-plugin .vimrc]].
...
|             | lldb        | gdb        | cdb          |
|-------------+-------------+------------+--------------|
| help        | (lldb) h    | (gdb) h    | 000> ?       |
|             | (lldb) help | (gdb) help | 000> !help   |
|             |             |            | 000> .help   |
|-------------+-------------+------------+--------------|
| environment |             |            | 000> !envvar |
|             |             |            |              |
