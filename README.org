...
@@html:<img
src="https://github.com/junjiemars/nore/workflows/Nore/badge.svg"
alt="clang, gcc and msvc" />@@
...
On Window:
- @@html:<kbd>@@M-x shell-command cc-env.bat && bash
  <your-c-app-dir>/configure --has-x@@html:</kbd>@@ or
  @@html:<kbd>@@M-x compile cc-env.bat && bash
